...
El dashboard ahora expone un selector expl�cito de modo/perfil de operaci�n de Nemotron:
...
- Cualquier perfil especializado seleccionado en el dashboard hace que el bot�n `Enviar turno` use `/api/profile-chat`.
...
- Repetir validaci�n live con Nebius/Nemotron bajo selector de perfil del dashboard.
